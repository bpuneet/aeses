...
<title>AES BI Server- Login</title>
<style type="text/css">
<!--
html, body {
	margin:0;
...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
  <tr height="94">
    <td bgcolor="#FFFFFF"><div id="container_header"><div id="links"><a href="http://www.pentaho.com" target="_blank">www.pentaho.com</a> | <a href="http://www.pentaho.com/contact/?puc=y" target="_blank"><%=Messages.getString("UI.PUC.LOGIN.CONTACT_US")%></a></div>
        <div class="pentaho-rounded-panel" style="width: 323px; padding: 20px 20px 20px 20px; position: absolute; margin: 199px 0 0 200px;">
              ...
              <tr>
                ...
                %>
				 <!-- <img src="/pentaho-style/images/login/about.png" width="18" height="16" align="absmiddle"/>-->
				  <a style="color: #fff; padding: 0 4px 0px 4px; font-size: .8em;" href="http://enst01ap02dv.aesenergystorage.com:8095/crowd/console/forgottenlogindetails!default.action" target="_blank" >Can't access your account?</a>
				<%
				} else {
				%>
				  &nbsp;
        ...
        <a href="http://www.aesenergystorage.com" target="_blank"><img src="/pentaho-style/images/login/logo.png" alt="AES Energy Storage" width="224" height="94" border="0" /></a></div></td>
  </tr>
  <tr height="334">
    <td class="dark"><div id="container_content">
	<!--<img src="/pentaho-style/images/login/title_text.png">
